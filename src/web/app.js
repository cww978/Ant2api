...
const KeyIcon = ({ size = 18, color = "currentColor" }) => (
  ...
  >
    ...
    <path d="m15.5 7.5-8.8 8.8a2.5 2.5 0 0 0-.7 1.8V21a1 1 0 0 0 1 1h2.9a2.5 2.5 0 0 0 1.8-.7l4.8-4.8" />
  </svg>
);
...
const RefreshCwIcon = RotateCwIcon;
...
function App() {
  const [token, setToken] = useState(
    () => localStorage.getItem("ant2api_admin_token") || "",
  );
  ...
  return (
    <>
      ...
      <header className="app-header">
        ...
        <div className="header-actions">
          <div className="header-status-pill">
            <span
              className={`status-indicator-dot ${proxyStatus.status}`}
            ></span>
            <span>
              {proxyStatus.status === "running"
                ? `代理端口 :${proxyStatus.port}`
                : "代理已停止"}
            </span>
          </div>
          <button
      ...
      <main className="app-main">
        ...
        {activeTab === "logs" && (
          <AuditLogsView apiFetch={apiFetch} showToast={showToast} />
        )}

        {activeTab === "settings" && (
          <SettingsView apiFetch={apiFetch} showToast={showToast} />
        )}
      </main>
    </>
  );
        ...
        <div className="config-form-grid">
          ...
          <div className="form-item">
            ...
            <input
              ...
              onChange={(e) =>
                setProxyConfig({
                  ...proxyConfig,
                  port: parseInt(e.target.value, 10) || 8090,
                })
              }
            />
            <span className="form-subtext">
              默认 8045 / 8090，修改端口需重启服务生效。
            </span>
          </div>
          ...
          <div className="form-item">
            <div className="form-label-row">
              ...
              <div
                ...
                onClick={() =>
                  setProxyConfig({
                    ...proxyConfig,
                    autoStart: !proxyConfig.autoStart,
                  })
                }
              >
                <div
                  className={`switch-control ${proxyConfig.autoStart ? "checked" : ""}`}
                >
            ...
            <input
              ...
              onChange={(e) =>
                setProxyConfig({
                  ...proxyConfig,
                  timeoutSeconds: parseInt(e.target.value, 10) || 120,
                })
              }
            />
            <span className="form-subtext">
              默认 120 秒，范围 30-7200 秒，修改后需重启服务生效。
            </span>
          </div>
          ...
          <div className="form-item">
            <div className="form-label-row">
              ...
              <div
                ...
                onClick={() =>
                  setProxyConfig({
                    ...proxyConfig,
                    allowLan: !proxyConfig.allowLan,
                  })
                }
              >
                <div
                  className={`switch-control ${proxyConfig.allowLan ? "checked" : ""}`}
                >
                  <div className="switch-thumb"></div>
                </div>
              </div>
            ...
            <div className="form-subtext highlight" style={{ marginTop: 6 }}>
              {proxyConfig.allowLan
                ? "🔓 监听 0.0.0.0，局域网所有设备可访问"
          ...
          <div className="form-item">
            <div className="form-label-row">
              <label className="form-label">
                访问授权{" "}
                <span className="help-icon" title="是否强制要求 API 密钥鉴权">
                  ⓘ
                </span>
              </label>
              <div
                ...
                onClick={() =>
                  setProxyConfig({
                    ...proxyConfig,
                    authEnabled: !proxyConfig.authEnabled,
                  })
                }
              >
                <span className="switch-label" style={{ fontSize: "0.8rem" }}>
                  {proxyConfig.authEnabled ? "已启用" : "已禁用"}
                </span>
                <div
                  className={`switch-control ${proxyConfig.authEnabled ? "checked" : ""}`}
                >
                  <div className="switch-thumb"></div>
                </div>
              </div>
            ...
            <div style={{ marginTop: 2 }}>
              ...
              <select
                ...
                onChange={(e) =>
                  setProxyConfig({ ...proxyConfig, authMode: e.target.value })
                }
              >
            ...
            <span className="form-subtext">
              开启后客户端需通过 Authorization: Bearer ... 传入 API
              密钥（健康检查 /health 免鉴权）。
            </span>
          </div>
          ...
          <div className="form-item full-width">
            <label className="form-label">
              ...
              <span
                className="help-icon"
                title="客户端调用反向代理时使用的 Master API Key"
              >
                ⓘ
              </span>
            </label>
            <div className="input-with-actions">
              ...
              <div className="input-trailing-actions">
                ...
                <button
                  ...
                  title="复制密钥"
                  onClick={() =>
                    copyToClipboard(proxyConfig.masterApiKey, "API 密钥")
                  }
                >
                  {copiedField === "API 密钥" ? (
                    <CheckIcon size={15} color="var(--accent-emerald)" />
                  ) : (
                    <CopyIcon size={15} />
                  )}
                </button>
            ...
            <span className="form-subtext highlight">
            ...
            <div className="input-with-actions">
              ...
              <div className="input-trailing-actions">
                ...
                <button
                  ...
                  title="复制密码"
                  onClick={() =>
                    copyToClipboard(proxyConfig.adminPassword, "后台密码")
                  }
                >
                  {copiedField === "后台密码" ? (
                    <CheckIcon size={15} color="var(--accent-emerald)" />
          ...
          <div className="form-item full-width">
            <div className="form-label-row">
              <label className="form-label">
                ...
                <span
                  className="help-icon"
                  title="伪装为官方 Antigravity / Gemini CLI 客户端 User-Agent"
                >
                  ⓘ
                </span>
              </label>
              <div
                ...
                onClick={() =>
                  setProxyConfig({
                    ...proxyConfig,
                    userAgentOverride: !proxyConfig.userAgentOverride,
                  })
                }
              >
                <div
                  className={`switch-control ${proxyConfig.userAgentOverride ? "checked" : ""}`}
                >
                  <div className="switch-thumb"></div>
                </div>
              </div>
            ...
            />
            <span className="form-subtext">
              示例：antigravity/1.15.8 darwin/arm64
            </span>
          </div>
        </div>
...
function DashboardView({ stats, proxyStatus, showToast }) {
  const proxyHost =
    proxyStatus.host === "0.0.0.0" ? "localhost" : proxyStatus.host;
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      ...
      <div className="glass-card">
        <div className="card-header-row">
          ...
          <span
            className={`badge ${proxyStatus.status === "running" ? "badge-success" : "badge-danger"}`}
          >
            {proxyStatus.status === "running"
              ? `服务在线 (${baseUrl})`
              : "服务已停止"}
...
function AccountsView({ accounts, onReload, apiFetch, showToast }) {
  ...
  const handleTest = async (id) => {
    try {
      ...
      const res = await apiFetch(`/api/admin/accounts/${id}/test`, {
        method: "POST",
      });
      if (res.success) {
  ...
  const handleRefresh = async (id) => {
    try {
      const res = await apiFetch(`/api/admin/accounts/${id}/refresh`, {
        method: "POST",
      });
      if (res.success) {
        ...
        const listener = (event) => {
          if (event.data?.type === "GOOGLE_OAUTH_SUCCESS") {
            ...
            setNewAcc((prev) => ({
              ...
              name:
                prev.name ||
                `Google Account ${Math.floor(Math.random() * 900 + 100)}`,
  ...
  const handleSyncAll = async () => {
    setSyncingAll(true);
    try {
      const res = await apiFetch("/api/admin/accounts/sync-all", {
        method: "POST",
      });
      if (res.success) {
        showToast(
  ...
  const getLiveCountdown = (resetTimeStr, fallback) => {
  ...
  const formatQuotasList = (quotas) => {
    ...
    // Fallback: find any model containing 'gemini'
                    ...
                    <tr key={acc.id}>
                      <td>
                        <div className="account-email-cell">
                          ...
                          {acc.enabled ? (
                            <span className="badge-status-enabled">
                              ● 正常可用
                            </span>
                          ) : (
                            <span className="badge-status-disabled">
                              🚫 反代已禁用
                            </span>
                          )}
                        </div>
                            ...
                            {quotaItems.map((q, qIdx) => {
                              ...
                              return (
                                <div className="quota-item-pill" key={qIdx}>
                                  <span className="quota-model-icon">
                                    {q.name.includes("Claude") ? "✳️" : "✦"}
                                  </span>
                                  <span
                                    className="quota-model-name"
                                    title={q.name}
                                  >
                                    {q.name}
                                  </span>
                                  ...
                                  <span
                                    className={`quota-percentage ${q.percentage === "0%" ? "depleted" : ""}`}
                                  >
                                    {q.percentage}
                                  </span>
                                </div>
              ...
              >
                <div className="form-item">
                  ...
                  <input
                    type="text"
                    className="text-input"
                    placeholder="例如: Google Account A"
                    value={newAcc.name}
                    onChange={(e) =>
                ...
                <div className="form-item">
                  ...
                  <input
                    ...
                    className="text-input font-mono"
                    placeholder="1//0..."
                    value={newAcc.refreshToken}
                    onChange={(e) =>
                      setNewAcc({ ...newAcc, refreshToken: e.target.value })
                    }
                  />
                </div>
              </div>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            创建分发给客户端使用的调用密钥，支持速率限制与模型白名单隔离
          </p>
        </div>
    ...
    try {
      ...
      if (res.success) {
        showToast(
          "success",
          "映射已创建",
          `${newMap.sourceModel} -> ${newMap.targetModel}`,
        );
        setShowModal(false);
        setNewMap({
          sourceModel: "",
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            将客户端发出的 OpenAI / Codex / GPT 模型请求无缝路由至指定的 Gemini
            模型
          </p>
        </div>
        <button className="btn btn-primary" onClick={() => setShowModal(true)}>
              ...
              >
                <div className="form-item">
                  ...
                  <input
                    ...
                    value={newMap.sourceModel}
                    onChange={(e) =>
                      setNewMap({ ...newMap, sourceModel: e.target.value })
                    }
                    required
                  />
                </div>
                <div className="form-item">
                  ...
                  <select
                    className="select-input"
                    value={newMap.targetModel}
                    onChange={(e) =>
                      setNewMap({ ...newMap, targetModel: e.target.value })
                    }
                  >
                    <option value="gemini-3.7-flash">
                      gemini-3.7-flash (极速首选)
                    </option>
                    <option value="gemini-3.7-thinking">
                      gemini-3.7-thinking (深度思考)
                    </option>
                    <option value="gemini-3.5-flash">
                      gemini-3.5-flash (轻量高并发)
                    </option>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            查看所有反向代理客户端请求的详细耗时、Token 消耗、上游账号与错误排查
          </p>
        </div>
        <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
          ...
          <button
            className="btn btn-primary"
            onClick={() => fetchLogs(page, pageSize, search, statusFilter)}
          >
      ...
      <div className="glass-card" style={{ padding: 20 }}>
              ...
              {logs.length === 0 ? (
                ...
                logs.map((l) => (
                  <tr key={l.id}>
                    ...
                    <td>
                      <span
                        className={`badge ${l.statusCode === 200 ? "badge-success" : "badge-danger"}`}
                      >
                        {l.statusCode}
                      </span>
                    </td>
                    ...
                    <td style={{ fontSize: "0.8rem" }}>
                      {l.accountName || l.accountId?.substring(0, 12) || "-"}
                    </td>
                    <td
                      style={{
                        fontSize: "0.8rem",
        ...
        <div className="pagination-container">
          <div className="pagination-info">
            <span>
              共 <strong style={{ color: "var(--text-main)" }}>{total}</strong>{" "}
              条记录
            </span>
            <span>
              第 <strong style={{ color: "var(--primary)" }}>{page}</strong> /{" "}
              {totalPages} 页
            </span>
          </div>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            配置出站网络代理、负载均衡调度策略、全局系统提示词与全量数据备份
          </p>
        </div>
      </div>
        ...
        >
          <div className="form-item">
            ...
            <select
              ...
              onChange={(e) =>
                setSettings({
                  ...settings,
                  loadBalanceStrategy: e.target.value,
                })
              }
            >
              <option value="round_robin">
                轮询调度 (Round Robin - 依次轮流使用每个可用账号)
              </option>
              <option value="least_errors">
                最小故障优先 (Least Errors - 优先选择错误率最低的最健康账号)
              </option>
          ...
          <div className="form-item">
            <label className="form-label">
              ...
              <span
                className="help-icon"
                title="用于服务器连接 Google API 的出站科学上网代理"
              >
                ⓘ
              </span>
            </label>
            ...
            />
            <span className="form-subtext">
              若服务器连接 Google API 遇到网络受限，可配置 Clash / V2Ray
              等出站代理地址。
            </span>
          </div>
          ...
          <div className="form-item">
            <label className="form-label">
              ...
              <span
                className="help-icon"
                title="账号遇到 429 配额耗尽或网络异常时的暂时休眠时间"
              >
                ⓘ
              </span>
            </label>
            <input
              ...
              onChange={(e) =>
                setSettings({
                  ...settings,
                  maxCooldownSeconds: parseInt(e.target.value, 10) || 60,
                })
              }
            />
            <span className="form-subtext">
              当某个 Google
              账号报错时，会自动冷却该时长，期间自动转移至其它健康账号。
            </span>
          </div>

          <div className="form-item">
            <label className="form-label">
              全局注入 System Prompt (可选){" "}
              <span
                className="help-icon"
                title="会在所有请求最前额外追加该系统提示词"
              >
                ⓘ
              </span>
            </label>
          ...
          <div className="form-item">
            <div className="form-label-row">
              ...
              >
                <div
                  className={`switch-control ${settings.enableDebugLogs ? "checked" : ""}`}
                >
                  <div className="switch-thumb"></div>
                </div>
              </div>
      ...
      <div className="glass-card">
        ...
        >
          导出当前所有账号凭据、API 密钥、模型路由映射及反向代理参数为 JSON
          文件，或从 JSON 文件全量恢复。
        </p>
